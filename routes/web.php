...
Route::get('/details/{id}', 'App\Http\Controllers\basile\LivreController@show');
...
Route::get('/details/{id}', 'App\Http\Controllers\basile\ClientController@show');
...
Route::get('/details/{id}', 'App\Http\Controllers\basile\CategoryController@show');
...
Route::get('/update-pret/{id}', 'App\Http\Controllers\basile\PretController@edit');
