...
@section('content')
    <form action="{{ url(isset($clients) ? 'update_livre/'.$clients->id : 'save_client')}}" method="POST">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" value="{{$clients->nom}}" name="nom" id="nom">
        </div>
        <div class="form-group">
            <label class="label-control" for="telephone">Telephone</label>
            <input class="form-control" type="text" value="{{$clients->telephone}}" name="telephone" id="telephone">
        </div>
        <div class="form-group">
            <label class="label-control" for="email">E-mail</label>
            <input class="form-control" type="email" value="{{$clients->email}}" name="email" id="email">
        </div>
